...
# mol structure
node_attributes['valence'] = Attribute('node', 'valence', one_hot=False)
node_attributes['charge'] = Attribute('node', 'charge', one_hot=False)
...
#             '/home/mpopova/Work/EAGCN/Data/HIV_updated.csv',
#             delimiter=',', cols=[0, 2])
...
model_params = {
    ...
    'batch_size': 256,
    'num_epochs': 300,
    'logdir': '/home/mpopova/Work/Project/logs/gcnn_log',
    'print_every': 1,
    'save_every': 5,
